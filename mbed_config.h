...
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         7000                                                                                             // set by application
#define MBED_CONF_APP_WIFI_DATAREADY                                          PE_1                                                                                             // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                                           "15April2015"                                                                                    // set by application
...
#define MBED_CONF_APP_WIFI_SSID                                               "Delilah"                                                                                        // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 ""                                                                                               // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     ""                                                                                               // set by application[*]
